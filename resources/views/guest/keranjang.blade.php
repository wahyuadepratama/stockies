  ...
  <div id="fh5co-product">
		...
		<div class="animate-box">
									...
									<form class="form-inline">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="form-group">
												<input type="" class="form-control" id="" placeholder="Masukkan kode voucher">
											</div>
										</div>
										<div class="col-md-12 col-sm-12 col-xs-12">
											<button type="submit" class="btn btn-default btn-block">Gunakan Voucher</button>
										</div>
									</form>
           ...
           <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:5%;">
             <a href="/pembayaran"><button style="background-color: rgba(191, 139, 22, .9);" type="submit" class="btn btn-warning btn-block">Lanjutkan Pembayaran</button></a>
           </div>
